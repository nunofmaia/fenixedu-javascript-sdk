...
var Api = {
    ...
    getAcademicTerms: function (callback) {
        'use strict';
        apiPublicRequest(requests.GET, endpoints.academicTerms, null, null, callback);
    },
    ...
    getDegrees: function (academicTerm, callback) {
        'use strict';
        var params = { academicTerm: academicTerm || '' };
        apiPublicRequest(requests.GET, endpoints.degrees, params, null, callback);
    },
